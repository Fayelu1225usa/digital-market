 ...
 * @author faye
 */
public class OrderHistoryScene extends javax.swing.JPanel {
     ...
     */
    public OrderHistoryScene(JFrame jf, Data data, Account account) {
        ...
        for(Order order : this.data.getBusiness().order_list.getOrders()){
           
            if(order.getCustomer().equals(this.cp)){
    ...
    private void initComponents() {
        ...
        String[] header = new String[]{"Date", "Total Price", "Status"};
        dtm.setColumnIdentifiers(header);

        for(Order order : this.orders){
            String[] row = new String[3];
            row[0] = order.getOrderDate();
            row[1] = String.valueOf(order.getOrderTotal());
